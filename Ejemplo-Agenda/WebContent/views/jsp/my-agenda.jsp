    ...
    <body>
        ...
        <div class="ui container">
            <div class="ui secondary  menu">
                <div class="item logo">
                    <a href="/Ejemplo-Agenda"><h2>Agenda<span>Telefonica</span></h2></a>
                </div>
                                ...
                                <c:forEach var="telefono" items="${user.telefonos}">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                           ...
                                           <div class="ui right floated small green labeled icon button" data-toggle="modal" data-target="#">
                                                <i class="edit call"></i> 
                                                <a href="tel:+593996874100">LLamar</a>
                                            </div>
                                            <div class="ui right floated small green labeled icon button" data-toggle="modal" data-target="#">
                                                <i class="edit icon.whatsapp "></i> 
                                                <a href="mailto:chuqui@gmail.com">Correo</a>
                                            </div>
                                            ...
                                            <form action="editar-telefono" method="POST">
                                                ...
                                                <div class="modal-body">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" minlength="10" maxlength="10" id="numero" name="numero" value="${telefono.numero}" required="" pattern="[0-9]+">
                                                    </div>
                                                    <div class="form-row">
        ...
        <footer>
            ...
            <div class="social_foote">
                <a href="https://www.facebook.com/jonathan.atancuri" target="_BLANK"><i class="fab fa-facebook-square"></i></a>
                <a href="https://github.com/JonathanAtancuri3218" target="_BLANK"><i class="fab fa-github-square"></i></a>
            </div>
            <p>&COPY; 2021 Todos los derechos reservados | Designed By Jonathan Atancuri</p>
        </footer>
