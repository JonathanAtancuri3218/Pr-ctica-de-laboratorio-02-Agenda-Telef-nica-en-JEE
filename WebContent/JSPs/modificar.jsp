...
<body>
	...
	<form action="/PracticaJEE/ModificarTele"
		...
		<label style="padding: 30px;" for="Name">Operadora:</label> <input
			type="text" name="operadora" required pattern="[A-Za-z]+" required>
		<input type="hidden" name="cedu"
			value="${sessionScope.variableSession}"> <input type="hidden"
			name="codigoo" value=<%= accountId %>>
		<hr />
		<input
