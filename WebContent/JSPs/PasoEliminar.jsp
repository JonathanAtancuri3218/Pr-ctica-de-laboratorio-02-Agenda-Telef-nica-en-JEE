...
<body style="background-color: powderblue;">
	...
	<h1
		style="color: blue; font-family: verdana; text-align: center; border: 1px solid black;">Inicio
		Sesion</h1>
	<form action="/AgendaTelefonica/Obtenercedula"
		style="border: 1px solid black; padding: 30px;">
		<input type="hidden" name="cod" value=<%=  accountId %>><input
